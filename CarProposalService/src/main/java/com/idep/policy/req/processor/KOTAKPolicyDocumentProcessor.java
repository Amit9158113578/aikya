 ...
 public class KOTAKPolicyDocumentProcessor implements Processor {
     ...
     try {
       if (this.serverConfig == null)
         try {
           ...
           this.log.error("KOTAKPOLICYDOCPRO|ERROR|unable to load configuration documents from db : ServiceURLConfig,WEBHOSTConfig", e);
         }  
       ...
       keyDataNode.put("uKey", userPolicyProfileNode.findValue("uKey").asText());
       keyDataNode.put("pKey", userPolicyProfileNode.findValue("pKey").asText());
       ...
       this.log.error(String.valueOf(String.valueOf(String.valueOf(exchange.getProperty("logReq").toString()))) + "KOTAKPOLICYDOCPRO" + "|ERROR|" + "Exception at KOTAKPolicyDocumentProcessor", e);
     } 
   }
 }
