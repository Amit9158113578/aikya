 ...
 public class BikeProposalAddressProcessor
   implements Processor {
   Logger log = Logger.getLogger(BikeProposalAddressProcessor.class.getName());
   ...
   public void process(Exchange exchange) throws Exception {
     try {
       ...
       this.log.info("proposalReqNode :" + proposalReqNode);
