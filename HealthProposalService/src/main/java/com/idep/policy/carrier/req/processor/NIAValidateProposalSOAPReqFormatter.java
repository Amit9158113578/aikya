...
public class NIAValidateProposalSOAPReqFormatter implements Processor{
	 Logger log = Logger.getLogger(NIAValidateProposalSOAPReqFormatter.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		 ...
		 */
		  if(configData.get("carrierSOAPConfig").get("reqConfig").has("removeAttrList")){
		   ...
		   while(keyList.hasNext()){
			   ...
			   log.info("NIA Values from save gen Replaced : Key : "+key);
		   }
		...
		{
			log.error(exchange.getProperty(ProposalConstants.LOG_REQ).toString()+ProposalConstants.POLICYCONF_REQ+"|ERROR|NIAApprovalProposalSOAPReqFormatter|",e);
