...
public class NIASOAPResponseFormatter implements Processor{

	Logger log = Logger.getLogger(NIASOAPResponseFormatter.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		try
		{
			...
			JsonNode resConfigData = exchange.getProperty("SoapReqConfDocument",JsonNode.class);
		...
		{
			log.error(exchange.getProperty(ProposalConstants.LOG_REQ).toString()+ProposalConstants.SERVICEINVOKE+"|ERROR|NIASOAPResponseFormatter|",e);
