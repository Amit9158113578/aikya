 ...
 public class TransformProposalRequest
   ...
   public void process(Exchange exchange) throws Exception {
     ...
     try {
       ...
       if (!requestNode.has("responseCode")) {
         requestNode = addBikeQuoteRequest(requestNode, ProposalValidationDocConfig);
         if (!requestNode.has("responseCode")) {
           ...
           if (!requestNode.has("responseCode")) {
             ...
             if (!requestNode.has("responseCode")) {
               ...
               if (!requestNode.has("responseCode")) {
                 ...
                 exchange.getIn().setHeader("bikeproposalService", serviceConfigNode.get("proposalServiceURL").textValue());
