...
public class HealthSoapResFormatter implements Processor {

	public HealthSoapResFormatter() {
		
	}
	
	Logger log = Logger.getLogger(HealthSoapResFormatter.class.getName());
...
public String ReplaceSpeicalCharcter(String data ,HashMap<Object,Object> replaceValue){
	...
	public String getPureResponse(String data, String tagName){
		...
		log.info("Soap Response Processed : "+formattedSoapRes.toString());
