...
public class TravelPolicyLogProcessor implements Processor {

	Logger log = Logger.getLogger(TravelPolicyLogProcessor.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		 ...
		 if(exchange.getProperty(ProposalConstants.DEFAULT_LOG)!=null)
		{
			...
			log.debug("Inside TravelPolicyLogProcessor final data"+data);
	 }
	}
