 ...
 public class ProposalReqDBStore implements Processor {
   ...
   public void process(Exchange exchange) throws Exception {
     ...
     try {
       ...
       if (docObj.containsKey("status") && docObj.get("status").equals("success")) {
         ...
         if (proposalDoc == null) {
           try {
             ...
             ExtendedJsonNode failure = (new ExceptionResponse()).failure("Failed to create bike proposal Document  :" + docId + " and exceptio  is :" + e);
             exchange.getIn().setBody(failure);
             throw new ExecutionTerminator();
           } 
         } else {
         ...
         this.log.error("Error while storing data in proposalId");
       } 
     } catch (Exception e) {
