...
public class NIASOAPRequestFormatter implements Processor{
	
	 Logger log = Logger.getLogger(NIASOAPRequestFormatter.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		try {
		  ...
		  JsonNode configData = exchange.getProperty("SoapReqConfDocument",JsonNode.class);
		  /**
