...
*/
public class TravelPolicyResProcessor implements Processor {
	
	ObjectMapper objectMapper = new ObjectMapper();
	Logger log = Logger.getLogger(TravelPolicyResProcessor.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		{
			this.log.error("TravelPolicyResProcessor Exception : ",e);
			ObjectNode obj = this.objectMapper.createObjectNode();
