...
public class BikeProposalLogProcessor implements Processor {
  Logger log = Logger.getLogger(BikeProposalLogProcessor.class.getName());
  ...
  public void process(Exchange exchange) throws Exception {
    ...
    if (exchange.getProperty("defaultLog") != null)
      data = String.valueOf(data) + exchange.getProperty("defaultLog"); 
