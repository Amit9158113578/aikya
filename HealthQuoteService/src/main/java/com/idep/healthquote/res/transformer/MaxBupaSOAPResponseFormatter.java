...
public class MaxBupaSOAPResponseFormatter  implements Processor {
	
	Logger log = Logger.getLogger(MaxBupaSOAPResponseFormatter.class.getName());
	...
	public void process(Exchange exchange) throws Exception {
		...
		try
		{
			...
			String soapResponse = getSoapResult(quoteResponse, startTagName, endTagName, removeAttrList, apppendTagName);
	...
	public String getSoapResult(String s, String startTagName, String endTagName, String testString[], String apppendTag)
	{
		try{
			...
			log.info("soapResponse : getSoapResult in MaxBupa : "+soapResponse);
			if(testString!=null){
