...
@Path("/AffiliateIntegrationService")
...
public class AffiliateIntegrationService {
	@POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	@Path("/create/integrate/invoke")
	public String createAffiliate(String input)
	{
		return null;
	}
	@POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	@Path("/delete/integrate/invoke")
	public String deleteAffiliate(String input)
	{
		return null;
	}
	@POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
	@Path("/update/integrate/invoke")
	public String updateAffiliate(String input)
	{
		return null;
	}
	@POST
	...
	public String fetchAffiliate(String input)
	{
		return null;
	}
	@OPTIONS
